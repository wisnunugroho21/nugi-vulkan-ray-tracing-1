...
namespace nugiEngine {
	...
	void EngineApp::loadObjects() {
		...
		materials.emplace_back(std::make_shared<Material>(Material{ glm::vec4(0.73f, 0.73f, 0.73f, 0.0f), 0.0f, 0.1f, 0.5f }));
		materials.emplace_back(std::make_shared<Material>(Material{ glm::vec4(0.12f, 0.45f, 0.15f, 0.0f), 0.0f, 0.1f, 0.5f }));
		materials.emplace_back(std::make_shared<Material>(Material{ glm::vec4(0.65f, 0.05f, 0.05f, 0.0f), 0.0f, 0.1f, 0.5f }));
		materials.emplace_back(std::make_shared<Material>(Material{ glm::vec4(0.73f, 0.73f, 0.73f, 0.0f), 0.0f, 0.1f, 0.5f }));
	...
	RayTraceUbo EngineApp::updateCamera(uint32_t width, uint32_t height) {
		...
		glm::vec4 lookFrom = glm::vec4(278.0f, 278.0f, -800.0f, 0.0f);
		glm::vec4 lookAt = glm::vec4(278.0f, 278.0f, 0.0f, 0.0f);
		glm::vec4 vup = glm::vec4(0.0f, 1.0f, 0.0f, 0.0f);
		...
		glm::vec4 u = glm::normalize(glm::cross(vup, w));
		glm::vec4 v = glm::cross(w, u);
