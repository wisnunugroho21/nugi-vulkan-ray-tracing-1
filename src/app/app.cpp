...
namespace nugiEngine {
	...
	void EngineApp::loadObjects() {
		...
		transforms.emplace_back(std::make_shared<TransformComponent>(TransformComponent{ glm::vec3(0.0f), glm::vec3(1.0f), glm::vec3(glm::radians(0.0f)) }));
		...
		transforms.emplace_back(std::make_shared<TransformComponent>(TransformComponent{ glm::vec3(265.0f, 0.0f, 295.0f, 0.0f), glm::vec3(1.0f), glm::vec3(glm::radians(0.0f), glm::radians(15.0f), glm::radians(0.0f))}));
		...
		transforms.emplace_back(std::make_shared<TransformComponent>(TransformComponent{ glm::vec3(130.0f, 0.0f, 65.0f, 0.0f), glm::vec3(1.0f), glm::vec3(glm::radians(0.0f), glm::radians(-18.0f), glm::radians(0.0f))}));
		transformIndex = static_cast<int>(transforms.size() - 1);
		...
		lights.emplace_back(std::make_shared<Light>(Light{ Triangle{ glm::vec3{213.0f, 554.0f, 227.0f}, glm::vec3{343.0f, 554.0f, 227.0f}, glm::vec3{343.0f, 554.0f, 332.0f} }, glm::vec3(100.0f, 100.0f, 100.0f, 0.0f)} ));
		lights.emplace_back(std::make_shared<Light>(Light{ Triangle{ glm::vec3{343.0f, 554.0f, 332.0f}, glm::vec3{213.0f, 554.0f, 332.0f}, glm::vec3{213.0f, 554.0f, 227.0f} }, glm::vec3(100.0f, 100.0f, 100.0f, 0.0f)} ));
	...
	RayTraceUbo EngineApp::updateCamera(uint32_t width, uint32_t height) {
		...
		ubo.lowerLeftCorner = lookFrom - viewportWidth * u / 2.0f + viewportHeight * v / 2.0f - w;
