...
HitRecord hitPrimitiveBvh(Ray r, float tMin, float tMax, int firstBvhIndex, int firstPrimitiveIndex, int transformIndex) {
  ...
  r.origin = transformations[transformIndex].inverseRotationMatrix * ((r.origin - transformations[transformIndex].translationVector) / transformations[transformIndex].scalingVector);
  r.direction = transformations[transformIndex].inverseRotationMatrix * (r.direction / transformations[transformIndex].scalingVector);
